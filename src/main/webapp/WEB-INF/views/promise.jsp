...
<body class="promBody">
	...
	<div class="promContent">
		<img id="promBack"
			src="${pageContext.request.contextPath}/img/promBackground.png">
	</div>
	<div class="chocfooter">
		<button class="book-btn" onclick="playvdo()">
			Lights Onn <span class="arrow">›</span>
		</button>
		<form action="promdetails" method="post">
