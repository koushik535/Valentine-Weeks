...
<body>
	<div class="main">
		...
		<div id="greet">
			...
			<p>This rose is red, but it still can’t compete with the passion
				...
				drive, and the way you never settle for less than what you deserve.
			</p>

			<p>Watching you chase your dreams makes me proud every single
				day. Stay sweet. Stay fierce. Stay you.</p>
	...
	<div class="song">
		...
		<form action="${pageContext.request.contextPath}/back" method="post">
			<button class="book-btn" onclick="playSong()">Back</button>
		</form>
	</div>
</body>
</html>